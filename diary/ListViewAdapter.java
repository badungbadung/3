...
public class ListViewAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = inflater.inflate(R.layout.list_item_breastmilk,parent,false);
        }
    ...
    public void addItem(Drawable icon, String time, String data){
        ListViewItem item = new ListViewItem(icon,time,data);
